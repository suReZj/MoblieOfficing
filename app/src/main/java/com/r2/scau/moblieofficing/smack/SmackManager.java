...
public class SmackManager {
     ...
     * Xmpp服务器地址
     */
    public static final String SERVER_IP = "192.168.13.61";
    /**
     * Xmpp 服务器端口
     */
     ...
     * 服务器名称
     */
    public static final String SERVER_NAME = "192.168.13.61";
    /**
     *
     */
...
//            Logger.e(TAG, e, "logout failure");
            Log.d("logout failure", e.toString());
            return false;
        }
    }
...
//            Logger.e(TAG, "change password failure", e);
            Log.d("change password failure", e.toString());
            return false;
        }
    }
    ...
    private String getMultiChatJid(String roomName) {
        ...
        return roomName + "@conference." + mConnection.getServiceName();
    }
